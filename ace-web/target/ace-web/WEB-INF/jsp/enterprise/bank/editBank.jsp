...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %> 
		...
		<form class="form-horizontal" method="post"
			action="${pageContext.request.contextPath}/bankList/updateBank.do"
			>
		<input type="hidden" name="id" value="${syBankList.id}"/>
			...
			<div class="form-horizontal">
				<div class="form-group">
					<label class="col-md-3 control-label">银行名称</label>
						...
						<input type="text" name="bankName" value="${syBankList.bankName }" />
					</div>
				</div>
				<div class="form-group">
