			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="${ctx}/customerService/addCustomerServicePage" method="post">
								...
								<div class="form-group">
									<label>联系电话1</label>
									<input class="form-control" type="text" name="telePhone1" value="" />
								</div>
								
								<div class="form-group">
									<label>联系电话2</label>
									<input class="form-control" type="text" name="telePhone2" value="" />
								</div>
								...
								<div class="form-group">
									<label>微信</label>
									<input class="form-control" type="text" name="wechat" value="" />
								</div>
								<div class="form-group">
									<label>状态</label>
