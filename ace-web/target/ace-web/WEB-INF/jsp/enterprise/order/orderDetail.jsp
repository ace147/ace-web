...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %> 
		...
		<div class="modal-body">
			...
			<div class="form-group">
				...
				${syDoctororder.syOrderDetail.code}
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">客户姓名</label>
				<div class="col-md-9 controls" style="margin-top:8px;">
				${syDoctororder.syOrderDetail.name}
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-9 controls" style="margin-top:8px;">
				${syDoctororder.jydUser.realName}
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">医生手机</label>
				<div class="col-md-9 controls" style="margin-top:8px;">
                     ${syDoctororder.jydUser.mobile}
				</div>
			</div>
			<div class="form-group">
			...
			<!-- <div class="form-group">
				<label class="col-md-3 control-label">医生处方</label>
				<div class="col-md-9 controls" style="margin-top:8px;">
