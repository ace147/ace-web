		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">微信用户资料</div>
					 ...
					 <%--  <div class="pull-left search" style="margin-left:20px;">
					  ...
					  <div class="columns pull-left" style="margin-left:20px;">
					   ...
					   <div class="fixed-table-container">
								...
								<table class="table table-hover">
									<thead>
										<tr>
											...
											<th  style>
											    <div class="th-inner sortable"> 微信名称 </div>
												<div class="fht-cell"></div>
											</th>
											<th  style>
									...
									<tbody>
										...
										<tr> 
											...
											<%--  <td style>${bean.nickname}</td> --%>
											 <td style>${bean.wechatName}</td>
											 <td style>
											     <c:if test="${bean.sex eq '1' }">男</c:if>
											     <c:if test="${bean.sex eq '2' }">女</c:if>
											 </td>
											 ...
											 <td style> 
											    <%--  <a href="${ctx}/jybUser/eidtPatientPage?id=${bean.id}" title="编辑"><span class="glyphicon glyphicon-pencil"></span></a>
											     &nbsp&nbsp&nbsp&nbsp --%>
											     <a href="${ctx}/wechatUser/wechatUserDetail?id=${bean.id}" title="查看" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-zoom-in"></span></a>
											    <%--  &nbsp&nbsp&nbsp&nbsp
						...
						<form id="form1" action="${ctx}/wechatUser/getWechatUserList">
