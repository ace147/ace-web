		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">修改疾病
					<button type="button" style="float:right;"class="btn btn-default" onclick="javascript:window.history.back();">返回</button>
					</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="${ctx}/basicillSet/updateBasicillSet" method="post">
							    <input class="form-control"  type="hidden" name="id" value="${syBasicillSet.id}">
								<div class="form-group">
										<label>疾病名称</label>
										<input class="form-control"  name="name" value="${syBasicillSet.name}">
								</div>
