		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">药方
					 <a href="${ctx}/medicineSet/addMedicinePage"><button type="button" style="float:right;"class="btn btn-default" >添加</button></a>
					</div>
					
					<div class="panel-body">
					<div class="bootstrap-table">
					<div class="fixed-table-toolbar">
					<form action="${ctx}/medicineSet/getMedicineList">
					  ...
					  <div class="columns pull-left">
					   ...
					   <div class="fixed-table-container">
					   		...
					   		<div class="fixed-table-body">
								<table class="table table-hover">
									<thead>
										<tr>
											<th  style>
											    <div class="th-inner sortable">药品编号</div>
											...
											<th  style>
											    <div class="th-inner sortable">生成产商</div>
												<div class="fht-cell"></div>
											</th>
											<th  style>
										...
										<tr>
											...
											<td style>${bean.editTor.realName}</td>
											 ...
											 <td style> 
											     ...
											     &nbsp&nbsp&nbsp&nbsp
											     <a href="${ctx}/medicineSet/removeMedicineSet?id=${bean.id}" title="删除"><span class="glyphicon glyphicon-remove"></span></a>
						...
						<form id="form1" action="${ctx}/medicineSet/getMedicineList">
