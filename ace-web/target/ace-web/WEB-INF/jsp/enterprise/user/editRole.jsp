...
<SCRIPT type="text/javascript">
		...
		$(document).ready(function(){
			...
			var permission=[];
			$.ajax({ 
		  		url:'${ctx}/permission/getCheckPermission?id=${role.id}', 
		  		type:'get', 
		  		dataType: 'json',
		  		data:{
			    ...
			    success: function(json) {
			    	$.each(json.result, function(i,entity){
			    		zNodes=json.result;
			    		//初始化树状图
