					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="${ctx}/discountSet/addDiscount" method="post">
								...
								<div class="form-group">
									<label>服务折扣</label>
									<input class="form-control" name="serviceDis">
								</div>
								
								<div class="form-group">
									<label>药费折扣</label>
									<input class="form-control" name="medicineDis">
								</div>
