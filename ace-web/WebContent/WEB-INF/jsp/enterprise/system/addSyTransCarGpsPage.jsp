		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">添加路线
					<button type="button" style="float:right;"class="btn btn-default" onclick="javascript:window.history.back();">返回</button>
					</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="${ctx}/syTransCarGps/addSyTransCarGps" method="post">
							
								<div class="form-group">
									<label>路线编号</label>
									<input class="form-control" name="lineNumber">
								</div>
								
								<div class="form-group">
									<label>路线名称</label>
									<input class="form-control" name="lineName">
								</div>
								
								<div class="form-group">
									<label>路线GPS</label>
									<input class="form-control" name="lineGPS">
								</div>
