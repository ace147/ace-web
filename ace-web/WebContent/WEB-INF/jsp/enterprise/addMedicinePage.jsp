						...
						<div class="col-md-6">
							<form role="form" action="${ctx}/medicineSet/addMedicine" method="post">
								...
								<div class="form-group">
									<label>生产产商</label>
									<div>
									<input class="form-control"  name="producter">
									</div>
								</div>
								<div class="form-group">
										<label>用法</label>
										<input class="form-control"  name="useway">
								</div>
								<div class="form-group">
									<label>用量</label>
								...
								<div class="form-group">
									<label>处方价格</label>
									<input class="form-control"  name="treatPrice">
								</div>
								<div class="form-group">
									<label>药包价格</label>
