...
import com.ace.common.constant.CommonConstant;
import com.ace.common.constant.SystemConstant;
import com.ace.common.model.FilesUploadModel;
import com.ace.common.model.decoder.BASE64Decoder;
...
public class FileHandler {
	...
	private static void createFolderIfNotExists(String filePath) {
		...
		if (!target.exists()) {
			String fatherPath = folderPath.substring(0, folderPath.lastIndexOf('/'));
